...
def loadData():  # 此时的数据还是h*w*c的形式
    # 读入数据
    data = sio.loadmat('../data/thz_img_roi.mat')['data']
    labels = sio.loadmat('../data/thz_label_gray.mat')['data']
...
def acc_reports(y_test, y_pred_test):
    # thz[太和镇]
    target_names = ['cultivated land', 'uncultivated land']
...
if __name__ == '__main__':
    ...
    Test_time = toc2 - tic2
    file_name = "cls_result/" + Name + "_report.txt"
    ...
    get_cls_map.get_cls_map(net, device, all_data_loader, y_all, Name)
